# # 🛒 MASTER PROMPT v3 – WEBSITE ECOMMERCE (PRODUCTION · KHÓA CỨNG)

Tôi đang phát triển hệ thống Ecommerce để quản trị.
...
## 3️⃣ THIẾT KẾ DATABASE (SCHEMA) VÀ MODELS


---

## 4️⃣ YÊU CẦU CHỨC NĂNG & UI (MASTER UI)

Xây dựng các Livewire Component trong `Modules/Admin`, `Modules/Website` với tiêu chuẩn **Master UI** (Đẹp, Hiện đại, UX cao).
Mỗi chức năng có thể thiết kế riêng thành Livewire Component
---
...
3.  **Bước 3:** Tạo `Service` để xử lý logic lưu/lấy settings JSON, hoặc Database
4.  **Bước 4:** Tạo route - controller - view (chứa layout) - call livewire trong view (livewrie tuyệt đối không có layout)
5.  **Bước 5:** Bắt đầu viết Livewire Component bên trong.
