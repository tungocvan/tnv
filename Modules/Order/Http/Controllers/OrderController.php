...
class OrderController extends Controller
{
    ...
    {
        return view('Order::pages.orders.index');
    }

    // Chúng ta sẽ làm trang chi tiết sau
    public function show($id)
    {
        return view('Order::pages.orders.show', compact('id'));
    }
    // --- TÍNH NĂNG MỚI ---
    ...
    public function exportPdf($id)
    {
        ...
        $pdf = Pdf::loadView('Order::pages.orders.invoice', compact('order') + ['isPdf' => true]);
    ...
    public function print($id)
    {
        ...
        return view('Order::pages.orders.invoice', compact('order'));
    }
}
