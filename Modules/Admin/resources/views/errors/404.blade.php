...
<body class="bg-gray-50 h-screen flex flex-col items-center justify-center text-center px-4">
    <div class="bg-white p-8 rounded-2xl shadow-lg max-w-md w-full border border-gray-100">
        ...
        <h1 class="text-2xl font-bold text-gray-900 mb-2">Trang không được tìm thấy (404)</h1>
        <p class="text-gray-500 mb-6">Xin lỗi, trang bạn đang tìm kiếm không tồn tại. Vui lòng kiểm tra lại đường dẫn hoặc quay lại trang chủ.</p>
